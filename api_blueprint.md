...
## School year for student [GET /student/school_year_ids]
...
Get last school year and student_id for student user [GET /student/school_year_id_student]
...
## School year for student [GET /parent/school_year_ids]
Get all school years with current school year name and id and other school years that he/she can select.
This method use all roles because all data(students, sections, marks, behaviors,semesters,attendances) are depend on school year
...
Get last school year and last child which added [GET /parent/school_year_id_child]
...
## School year for user [GET /teacher/school_year_ids]
Get all school years with current school year name and id and other school years that he/she can select.
This method use all roles because all data(students, sections, marks, behaviors,semesters,attendances) are depend on school year
...
Get last school year and group where teacher teach some subject [GET /teacher/school_year_id_group]
...
## School year for user [GET /librarian/school_year_ids]
Get all school years with current school year name and id and other school years that he/she can select.
This method use all roles because all data(students, sections, marks, behaviors,semesters,attendances) are depend on school year
